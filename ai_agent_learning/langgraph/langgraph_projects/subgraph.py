...
fa_builer = StateGraph(
    state_schema=FailureAnalysisState, output_schema=FailureAnalysisOutputState
)
fa_builer.add_node("get_failures", get_failures)
fa_builer.add_node("generate_summary", generate_summary)
fa_builer.add_edge(START, "get_failures")
fa_builer.add_edge("get_failures", "generate_summary")
fa_builer.add_edge("generate_summary", END)

graph = fa_builer.compile()
